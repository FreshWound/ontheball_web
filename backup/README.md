# ontheball — web basemap prototype (v0.6.1)

**Versioning note**: deliverables are named with a version number
(`ontheball_web_v0.6.1.zip`, folder `otb_web_v0.6.1/`) so a broken WIP
...
## What's new in v0.6.1 — Base Velocity fix (dealiasing)
...
```bash
cd otb_web_v0.6.1        # or wherever you unzipped this version
